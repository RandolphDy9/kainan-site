...
export default function ImageCarousel() {
  ...
  useEffect(() => {
    setCurrentIndex((prev) =>
      Math.min(prev, Math.max(0, foodImages.length - slidesPerView))
    );
            ...
            <div
              ...
              style={{
                transform: `translateX(-${
                  (currentIndex * 100) / safeSlidesPerView
                }%)`,
              }}
            ...
            >
              {foodImages.map((image, index) => (
                <div
                  ...
                  className="px-2"
                  style={{
                    minWidth: `${100 / safeSlidesPerView}%`,
                ...
                >
                  <div className="relative w-full h-[380px] sm:h-[460px] md:h-[500px] rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center cursor-pointer">
                    <Image
                      ...
                      quality={50}
                      onClick={() =>
                        handleImageClick(image.src, `Food ${index + 1}`)
                      }
                    />
                  </div>
                </div>
